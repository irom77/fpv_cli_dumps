...
_Auto-generated by the `fpv-fleet-update` skill on 2026-09-07 from the Betaflight CLI dumps in this folder._
...
- **Class:** 14× whoop, 3× cinewhoop, 6× micro, 9× 5-inch, 2× 7-inch. Size class inferred from craft name / board where `hardware.csv` doesn't set it.
...
- **ESC protocol:** 21× DSHOT300, 2× DSHOT600.
