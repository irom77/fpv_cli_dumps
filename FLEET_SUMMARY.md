...
_Auto-generated by the `fpv-fleet-update` skill on 2026-09-21 from the Betaflight CLI dumps in this folder._

Source data: `fpv_quads.csv` (full history) and `fpv_quads_latest.csv` (newest dump per quad, 35 quads). Values come from `diff all` dumps, which only record settings that differ from firmware defaults — a blank cell means the setting is at its firmware default, not that it is missing.
...
| prospec | 7-inch | race | active | HOBBYWING_XROTORF7CONV | F7X2 | 4.5.3.KAACK_V19 | - | - | - | 2026-09-04 |
...
| TTV2 | 3-inch | race | active | HAKRCF411D | F411 | 4.5.1 | DSHOT600 | HD | CRSF | 2026-09-21 |
...
- **Status:** 24× active, 5× broken, 3× retired, 3× incomplete. Lifecycle from `hardware.csv`; a blank there counts as active.
...
- **Video:** 13× HD, 2× Auto, 2× Analog. Quads showing `-` have `vcd_video_system` at firmware default in the diff — not necessarily video-less.

## Needs attention

**Broken (needs repair — grounded until fixed):** Crux-fish, Diamond, Green Hornet V3, Meteor85, QAS JB.
...
_Note: BETAFPVF4SX1280, FLYWOOF405S_AIO, HOBBYWING_XROTORF7CON, HOBBYWING_XROTORF7CONV, XILOF4 are keyed by board name because their dumps had no craft name set (`set craft_name` / `# name:`). Setting a craft name makes future tracking more reliable._
...
| prospec | 176/156/156 | 587/520/520 | 0/0/0 | 135/120/120 | — | BETAFLIGHT | dump |

**race — 3-inch**

| Quad | Center °/s | Max °/s | Expo | @50% | Preset | Type | Source |
|---|---|---|---|---|---|---|---|
| TTV2 | 190/160/160 | 633/533/533 | 0/0/0 | 146/123/123 | — | BETAFLIGHT | dump |
...
| AOS5 |  |  | GEPRC F722 AIO (same MCU as retired Crocodile5 baby) | GEPRC 2004 2550KV |  |  |  | AOS5 5-inch frame; partial build confirmed by owner 2026-09-11: frame / motors / FC / RX only. RX model unknown; dump configures CRSF on UART3. MCU 002700335333500820333931 matches unnamed 2024-08-27 GEPRC_F722_AIO backup and retired Crocodile5 baby; retired donor build retained separately. Battery / props / weight unconfirmed. |
| Cine-fish | 4S |  | GEPRC F411 AIO (built-in) | GR1404 3850KV | T3x3x3 | CaddxFPV Baby Ratel 2 | Rush Tiny Tank (analog) | Successor of CineLog30 (migrated to Flyfish30 frame); GR1404 3850KV motors moved from CineLog30; props/cells carried from CineLog30 - verify. Rush Tiny Tank installed 2026-09-18 (pilot confirmed), superseding the planned Rush Tank Ultimate Mini conversion. Latest dump configures SmartAudio on UART1 and R8 (5917 MHz), power index 1 (25 mW table label); Latest 2026-09-18 14:35:15 dump confirms MAX7456 / AUTO analog OSD with 30x13 canvas. Video and Betaflight analog OSD confirmed on HDZero Monitor in RF Auto at A1 (5865 MHz); static on Raceband was a channel mismatch. SmartAudio Device ready remains false; DATA-to-T1 continuity confirmed by pilot. SmartAudio 2.1 identification is from the VTX sticker, not a detected protocol. Upgraded live FC to BF 4.5.5 with NONCOMPLIANT_SMARTAUDIO selected; still Device ready=false after restore and power cycle. Inclusion in actual build unverified; archived 2026-09-19 08:09:01 dump confirms BF 4.5.5, yaw_motors_reversed=ON (props-out), pid_process_denom=2, and MAX7456/AUTO. Pilot reordered motors and changed directions to props-out; the latest short Blackbox test ends with a switch disarm and no runaway. Dump retains motor_output_reordering=0,1,2,3,4,5,6,7 and motor resources B04/B05/B06/B07, so the reported reordering mechanism is not established by this dump. See docs/troubleshooting/cine-fish-rush-tiny-tank-smartaudio.md. CaddxFPV Baby Ratel 2 analog camera installed and wired through the Rush Tiny Tank pads (pilot confirmed 2026-09-18). Pilot-reported wiring: FC 5V + camera VCC to VTX +5V; FC GND + camera GND to VTX GND; FC video input + camera video to VTX CAM; FC video output to VTX VTX; FC T1 to VTX DATA. Status remains incomplete pending SmartAudio resolution and flight readiness confirmation; disposition of the former Caddx Vista unconfirmed. |
...
| Crux-fish | 4S | 115g | Built-in 20A BLHeli_S 4-in-1 | HappyModel EX1404 3500KV | HQProp T3.5x2x3 | HDZero Nano V3 HD FPV Camera | Onboard HDZero | HDZero Crux35; 113mm. Camera upgraded and Motor 3 replaced. Still broken: gyro sensor (ICM42688P) flatlines/locks up to 0 under battery power due to ESC electrical noise on takeoff. Solder new local Low-ESR capacitor to FC to resolve. |
...
| Green Hornet V3 | 6S | 280.1g without battery | SucceX-E Mini F7 FC + 35A BLHeli_S 4-in-1 ESC | XING 1507 2800KV on M1/M2/M4; Racerstar Racing Edition BR1507 2800KV on M3 (mismatched replacement) | 3040 3-blade | RunCam Nano2 2.1mm NTSC 4:3 | SucceX-E 300mW analog VTX | iFlight Green Hornet V3 3-inch cinewhoop; 145mm wheelbase; FC target IFLIGHT_SUCCEX_E_F7; 6S variant confirmed by pilot. Broken 2026-09-14: flips at liftoff. Two independent faults found. FIXED: deadband and yaw_deadband were both 0 with sticks not resting at exact centre, so a residual offset became a standing rate demand that integrated without bound on the ground; set both to 2 and verified on the bench (yaw I-term -160 to -2). Also fixed: the 4.2.4 to 2026.6.1 upgrade reinterpreted yaw_rc_rate 172 from a BETAFLIGHT multiplier into 1720 deg/s ACTUAL centre sensitivity, which made the offset 5x worse; rates restored to 20/20/34 and srate 67/67/115. OPEN and blocking: Motor 3 (Racerstar BR1507, not the original XING) runs 14% below the other three at matched command under load versus 7.4% unloaded, so roughly 26% less thrust on that corner. Swap its prop with Motor 1 to separate prop from motor, then replace the motor with a XING 1507 2800KV. See docs/troubleshooting/green-hornet-post-upgrade-takeoff-failure.md. Also open there: trim sticks to 1500, FLIP OVER AFTER CRASH overlaps the old ANGLE detent, analog OSD points at MSP DisplayPort, no ESC config export, AIRMODE currently off to match 4.2.4. |
...
| QAS JB | 4S | sub-250g | 35A AM32 3-6S | XILO Stealth 1404 4500KV | Gemfan Hurricane 3020 3-blade | Caddx (analog) | None (moved to Mass) | Lumenier QAV-S 2 Sub-250, JB Special Edition, 3in / 1404 build (matches sheet Fleet2 QAV-S 2). Converted from HDZero to analog with Caddx cam. SpeedyBee TX800 moved to Mass 2026-09-10; no VTX currently installed. Broken 2026-07-21. Blackbox bench ramp 2026-09-07 isolates no/near-zero RPM on Motor 2 and Motor 4; inspect those motors, phase connections, and ESC channels. |
| Race5 |  |  |  |  |  |  |  | Race whoop on the shared 100/100/100 + 70/70/70 rate; build details TBD. |
| TTV2 | 3S/4S |  | HAKRC F411 AIO | VCI 1605 2800KV | HQProp T3.5x2.5x3 (1.5mm) | HDZero camera | HDZero Freestyle V2 | Five33 Tiny Trainer V2 HDZero Ready To Fly; carbon-fiber 3-inch frame; HappyModel EP1/EP2 2.4GHz ELRS receiver, firmware 3.0.1 (2470fc) ISM2G4; listed battery options 650mAh 4S or 850mAh 3S (battery not included). Product: https://flyfive33.com/products/five33-hdzero-tiny-trainer-v2-ready-to-fly?variant=53440036897062. Runtime snapshot 2026-09-21 confirms Betaflight 4.5.1 / HAKRCF411D, ICM42688P gyro+ACC, DPS310 barometer, 16MB flash, and 0 I2C errors; RXLOSS/CLI/MSP arming flags were present while connected over USB. |
...
**Green Hornet V3** — 27 flights, 170s total, 158 mAh total, worst sag 5.94V (2026-09-14).  ⚠️ 14 flagged flights.

| Date | Dur | Batt | Min | Sag | Avg A | Peak A | mAh | Motor sat | Flags | Comment |
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-14 | 4s | 6S 24.88V | 19.73V | 5.15V | 4.6A | 114.8A | 6 | 2.3% | LOW_CELL | Failed takeoff, not a flight. ROOT CAUSE: the 4.2.4 to 2026.6.1 upgrade on 2026-09-05 reinterpreted the stored yaw rate. Rateprofile 0 holds yaw_rc_rate = 172, which was a 1.72x BETAFLIGHT multiplier under 4.2 but is 1720 deg/s of ACTUAL centre sensitivity under 2026.6.1, against roll/pitch at 7 (70 deg/s). All three axes rest at the same one-unit stick offset, but only yaw turns it into a command: roll +1 and pitch +1 give setpoint 0, yaw -1 gives setpoint -3 deg/s (-1/500 x 1720 = -3.44, matching the log exactly). Under 4.2 the same offset gave about -0.69 deg/s. With yaw_deadband = 0 nothing absorbs it and the quad cannot yaw on the ground, so once throttle crosses min_check 1050 the YAW I-term alone integrates from -14 to about -70 in 0.5 s while roll/pitch/P/D/F stay at noise level; at liftoff it dumps into the mixer (motors [617,350,180,681], yaw mixer component 768 at t=4.01 s). Departure at t=4.28 s reaches -475 deg/s, 114.8 A, 24.88 to 19.73 V. The 4 s throttle creep is what gave the integrator time. Fix: set yaw_rc_rate = 7 on rateprofile 0, centre the yaw stick, set yaw_deadband = 2, and punch the throttle. flightModeFlags constant at 8388609 - turtle not active, and ANGLE was not in use (pilot took off with AUX2/3/4 at 1000). LOW_CELL is a consequence of the current spike; median current is 1.4 A. Motor 3 being a Racerstar BR1507 rather than the original XING is a separate open item - the quad flew with it. See docs/troubleshooting/green-hornet-post-upgrade-takeoff-failure.md. |
| 2026-09-14 | 5s | 6S 24.7V | 18.76V | 5.94V | 5.3A | 105.7A | 7 | 3.5% | LOW_CELL | Second identical failed takeoff, same root cause. Stationary ramp to 1226 (23%) over 4.5 s; yaw stick again at -1 for every frame giving a standing -3 deg/s setpoint, yaw I-term 0 below min_check then integrating to about -74. Departure at t=4.54 s reaching 738 deg/s, 105.7 A, 24.70 to 18.76 V. Reproduces log 3 exactly, ruling out a one-off snag or pilot input. See docs/troubleshooting/green-hornet-post-upgrade-takeoff-failure.md. |
| 2026-09-14 | 4s | 6S 24.88V | 19.73V | 5.15V | 4.6A | 114.8A | 6 | 2.3% | LOW_CELL | — |
| 2026-09-14 | 5s | 6S 24.7V | 18.76V | 5.94V | 5.3A | 105.7A | 7 | 3.5% | LOW_CELL | — |
| 2026-09-14 | 5s | 6S 24.84V | 19.08V | 5.76V | 5.1A | 114.9A | 7 | 2.3% | LOW_CELL | Test flight after the rate fix (rc_rates 20/20/34, srate 67/67/115 confirmed in the log header). THE RATE FIX DID NOT SOLVE IT. It did work as designed: yaw setpoint dropped from -3 to -1 and yaw I-term stayed at -12 instead of -70, so the yaw windup is gone. The quad flipped anyway, and this time on ROLL. Sequence: 4 s of armed idle with I-term at exactly 0 and clean gyro (unfiltered RMS 2.9/8.5/7.0 deg/s - this is NOT a vibration problem). At t=4.4 s throttle reaches 1126. From t=4.72 a real roll develops (gyro -16, -24, -31, -45, -58 deg/s); the FC pins Motor 2 at the 158 floor for ~25 ms while driving Motor 3 to ~1200, and the roll does not arrest. At t=4.75 it reverses violently, accZ jumps 2040 to 2930, motors swing to opposite rails (Motor 2 to 2047, Motor 3 to 158), 114.9 A peak, 24.84 to 20.82 V. Motors reach both extremes while throttle is only ~19%, which is full attitude authority at low throttle. Leading candidate is now feature AIRMODE, which the dumps show was at 4.2's default of OFF and is at 2026.6.1's default of ON. Four hypotheses have now been disconfirmed by test; the log gives the mechanism but not which changed setting causes it. See docs/troubleshooting/green-hornet-post-upgrade-takeoff-failure.md. |
| 2026-09-14 | 4s | 6S 24.88V | 19.73V | 5.15V | 4.6A | 114.8A | 6 | 2.3% | LOW_CELL | — |
| 2026-09-14 | 5s | 6S 24.7V | 18.76V | 5.94V | 5.3A | 105.7A | 7 | 3.5% | LOW_CELL | — |
| 2026-09-14 | 5s | 6S 24.84V | 19.08V | 5.76V | 5.1A | 114.9A | 7 | 2.3% | LOW_CELL | — |
| 2026-09-14 | 4s | 6S 24.84V | 20.86V | 3.98V | 3.8A | 52.1A | 5 | 0.0% | — | — |
| 2026-09-14 | 9s | 6S 24.42V | 24.07V | 0.35V | 2.2A | 11.0A | 5 | 0.0% | — | — |
| 2026-09-14 | 10s | 6S 24.64V | 23.97V | 0.67V | 2.3A | 11.2A | 7 | 0.0% | — | — |
| 2026-09-14 | 4s | 6S 24.88V | 19.73V | 5.15V | 4.6A | 114.8A | 6 | 2.3% | LOW_CELL | — |
| 2026-09-14 | 5s | 6S 24.7V | 18.76V | 5.94V | 5.3A | 105.7A | 7 | 3.5% | LOW_CELL | — |
| 2026-09-14 | 5s | 6S 24.84V | 19.08V | 5.76V | 5.1A | 114.9A | 7 | 2.3% | LOW_CELL | — |
| 2026-09-14 | 4s | 6S 24.84V | 20.86V | 3.98V | 3.8A | 52.1A | 5 | 0.0% | — | — |
| 2026-09-14 | 9s | 6S 24.42V | 24.07V | 0.35V | 2.2A | 11.0A | 5 | 0.0% | — | — |
| 2026-09-14 | 10s | 6S 24.64V | 23.97V | 0.67V | 2.3A | 11.2A | 7 | 0.0% | — | — |
| 2026-09-14 | 13s | 6S 24.75V | 24.03V | 0.72V | 1.3A | 11.4A | 4 | 0.0% | — | Props-off bench ramp after setting deadband = 2 and yaw_deadband = 2 (airmode already off). The I-term runaway is FIXED: all three sticks now read exactly 0 at rest where log 10 had yaw resting at -1; yaw setpoint 0, yaw I-term peaks at -2 against -160 and still climbing in log 10; pitch I-term -1 against +48; motor spread with sticks centred is 6 to 30 across the ramp to 1486 throttle, against a runaway past 253. The roll excursion to -73 at t=7.2-8.0 s is a real stick input (rcRoll -7 to -10, back to exactly 0) winding up against the clamp - a bench artifact. CAUTION: the Motor 3 comparison taken from this log is INVALID for judging motor health. Props-off runs the motor unloaded, which hides a torque deficit; log 13 with props fitted shows Motor 3 at -14% where this log shows -7.4%. Do not use unloaded data to clear a motor. See docs/troubleshooting/green-hornet-post-upgrade-takeoff-failure.md. |
| 2026-09-14 | 4s | 6S 24.88V | 19.73V | 5.15V | 4.6A | 114.8A | 6 | 2.3% | LOW_CELL | — |
| 2026-09-14 | 5s | 6S 24.7V | 18.76V | 5.94V | 5.3A | 105.7A | 7 | 3.5% | LOW_CELL | — |
| 2026-09-14 | 5s | 6S 24.84V | 19.08V | 5.76V | 5.1A | 114.9A | 7 | 2.3% | LOW_CELL | — |
| 2026-09-14 | 4s | 6S 24.84V | 20.86V | 3.98V | 3.8A | 52.1A | 5 | 0.0% | — | — |
| 2026-09-14 | 9s | 6S 24.42V | 24.07V | 0.35V | 2.2A | 11.0A | 5 | 0.0% | — | — |
| 2026-09-14 | 10s | 6S 24.64V | 23.97V | 0.67V | 2.3A | 11.2A | 7 | 0.0% | — | — |
| 2026-09-14 | 13s | 6S 24.75V | 24.03V | 0.72V | 1.3A | 11.4A | 4 | 0.0% | — | — |
| 2026-09-14 | 5s | 6S 24.73V | 24.13V | 0.60V | 1.5A | 9.6A | 2 | 0.0% | — | — |
| 2026-09-14 | 3s | 6S 24.51V | 20.82V | 3.69V | 4.3A | 67.7A | 4 | 0.0% | — | First takeoff attempt with props fitted after the deadband fix. FLIPPED AGAIN, and this log identifies the remaining fault: MOTOR 3 IS DOWN UNDER LOAD. Across 2.4 s of steady props-on idle at matched commands, eRPM is Motor1 402, Motor2 419, Motor3 352, Motor4 408 - Motor 3 is 14.1% below the mean of the other three at command 158-200 and 13.9% at 200-260. The same measurement props-off gives only -7.4%, so the deficit doubles under load: a motor that cannot hold RPM against torque. Thrust goes as RPM squared, so 14% less RPM is roughly 26% less thrust on that corner, which is ample to flip the quad at liftoff. The deadband fix is confirmed holding - I-terms sit at exactly 0 through 2.4 s of idle. At t=2.6 s throttle reaches 1092, by 2.8 s the quad is rotating, and by 3.0 s gyro pitch hits 419 deg/s; 67.7 A peak, 24.51 to 22.74 V. Next: swap the Motor 3 prop with Motor 1 and repeat an idle-only props-on capture to separate prop from motor; then replace the motor. See docs/troubleshooting/green-hornet-post-upgrade-takeoff-failure.md. |
...
**QAS JB** — 1 flight, 4s total, 1 mAh total, worst sag 2.47V (2026-09-07).

| Date | Dur | Batt | Min | Sag | Avg A | Peak A | mAh | Motor sat | Flags | Comment |
|---|---|---|---|---|---|---|---|---|---|---|
| 2026-09-07 | 4s | 4S 15.88V | 13.41V | 2.47V | 1.0A | 11.6A | 1 | 12.7% | — | Bench ramp: m1/Motor 2 and m3/Motor 4 produced essentially no bidirectional-DShot RPM while m0/Motor 1 and m2/Motor 3 spun normally. FC commanded m1 to 100% as yaw diverged, but it remained at 0 RPM. Receiver stayed valid with no failsafe. Diagnose motors, phase connections, and ESC channels 2/4; this is not a PID-tuning issue. The 13.41 V minimum occurs only in the final 11 ms and should not be treated as sustained battery sag. |
