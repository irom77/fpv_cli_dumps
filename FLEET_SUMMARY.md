...
| openracer2 | 6S | 280g dry (no props/battery) | Foxeer Reaper 20x20 ESC + Foxeer Mini F722 V4 20x20 FC (MPU6000) | HeadsUp \| Five33 2207 1960KV (MR30 connectors) | Hurricane MCK 51466 V2 | Foxeer Predator Nano |  | Analog Open Racer (RTF); ELRS; Core 5.8 RHCP antenna. Second OpenRacer build (see Kronos); same props as Kronos. VTX model not yet confirmed. |
