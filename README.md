...
flights.csv              One row per decoded blackbox flight (duration, sag, current, mAh)
FLEET_SUMMARY.md         Human-readable overview: fleet table, rollups, "needs attention", flights
